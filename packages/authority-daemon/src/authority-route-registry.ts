...
import { resolveAuthorityChatCommandRoute, type AuthorityChatCommandRouteDependencies } from "./chat-command-routes";
import {
  resolveAuthorityCompanyManagementRoute,
  type AuthorityCompanyManagementRouteDependencies,
} from "./company-management-routes";
import {
  resolveAuthorityCompanyStateRoute,
  type AuthorityCompanyStateRouteDependencies,
} from "./company-state-routes";
