import type { Company, RequirementRoomMessage } from "../../domain";
import type {
...
import { isInternalAssistantMonologueText, isSyntheticWorkflowPromptText, stripTruthInternalMonologue } from "../mission/message-truth";
import { requestTopicMatchesText } from "../delegation/request-topic";
import { sortRequirementRoomMemberIds } from "../delegation/room-routing";
