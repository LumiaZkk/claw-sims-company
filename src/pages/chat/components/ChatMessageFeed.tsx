          ...
          return (
            <div key={item.id} className="flex justify-center">
              ...
              >
                ...
                <ChatDetailDisclosure detailContent={item.detailContent} label="查看完整结果" />
              </div>
            </div>
          );
        }
