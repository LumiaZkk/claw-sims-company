...
import { DepartmentManagerDialog } from "../../../ui/department-manager-dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { HrDepartmentPlanDialog } from "../../../ui/hr-department-plan-dialog";
import { ImmersiveHireDialog, type HireConfig } from "../../../ui/immersive-hire-dialog";
import { OrgChart } from "../../../ui/org-chart";
import type { HrPlanDialogState } from "../../../ui/hr-department-plan-dialog";
...
export function EmployeeDirectoryDialogs(props: {
  companyId: string;
  templates: import("../../../domain/org/types").AgentTemplateDefinition[];
