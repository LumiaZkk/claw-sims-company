...
import {
  ...
  type AuthorityCompanyRuntimeSnapshot,
} from "../application/gateway/authority-runtime-sync";
import { useCompanyRuntimeStore } from "../application/company/runtime-store";
