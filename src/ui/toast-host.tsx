            ...
            <div className="min-w-0">
              ...
              {item.actionLabel && item.onAction ? (
                <div className="mt-3 flex items-center gap-2">
                  <button
                    type="button"
                    className="rounded-md border border-current/30 px-2 py-1 text-[11px] font-semibold"
                    onClick={() => {
                      item.onAction?.();
                      dismiss(item.id);
                    }}
                  ...
                  <button
                    type="button"
                    className="text-[11px] opacity-80 underline-offset-2 hover:underline"
                ...
                <button
                  type="button"
                  className="mt-3 text-[11px] opacity-80 underline-offset-2 hover:underline"
                  onClick={() => dismiss(item.id)}
                >
                  关闭
                </button>
